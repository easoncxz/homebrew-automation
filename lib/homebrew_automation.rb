...
module HomebrewAutomation
  ...
  def self.update_formula_field field, value, klass
    update(
      klass,
      [ by_type('begin'),
        by_both(
  ...
  def self.put_bottle os, sha256, klass
    update(
      klass,
      bot_begin_path,
  ...
  def self.put_bottle_version os, sha256
    -> (bot_begin) {
      bot_begin.updated(
